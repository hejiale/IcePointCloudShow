...
@interface IPCSaleserOptometryInfoView()
...
@implementation IPCSaleserOptometryInfoView
...
- (instancetype)initWithFrame:(CGRect)frame ChooseBlock:(void(^)())choose
{
    ...
    if (self) {
        ...
        UIView * view = [UIView jk_loadInstanceFromNibWithName:@"IPCSaleserOptometryInfoView" owner:self];
