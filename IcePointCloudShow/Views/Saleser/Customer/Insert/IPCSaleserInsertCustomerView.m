...
@interface IPCSaleserInsertCustomerView()<UITextFieldDelegate,IPCDatePickViewControllerDelegate,IPCParameterTableViewDelegate,IPCParameterTableViewDataSource>
...
- (instancetype)initWithFrame:(CGRect)frame UpdateBlock:(void (^)(NSString *))update
{
    ...
    if (self) {
        ...
        UIView * view = [UIView jk_loadInstanceFromNibWithName:@"IPCSaleserInsertCustomerView" owner:self];
