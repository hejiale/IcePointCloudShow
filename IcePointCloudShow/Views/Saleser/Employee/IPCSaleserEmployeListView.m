...
@interface IPCSaleserEmployeListView()<UITableViewDataSource,UITableViewDelegate,UITextFieldDelegate>
...
@implementation IPCSaleserEmployeListView
...
- (instancetype)initWithFrame:(CGRect)frame DismissBlock:(void(^)(IPCEmployee *))dismiss
{
    ...
    if (self) {
        ...
        UIView * view = [UIView jk_loadInstanceFromNibWithName:@"IPCSaleserEmployeListView" owner:self];
        view.frame = frame;
